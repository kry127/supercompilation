...
class SupercompilationTest {
    ...
    fun kmpReductionStepsTest() {
        ...
        val superheader = "   input size  |                                pattern size                                   "
        ...
        println()
        println("The time measured in beta reduction steps.")
        println("There are $groupDatasetSize measures averaged in one cell of the table!")
        println()
    }
    ...
    fun kmpPerformanceTest() {
        ...
        val superheader = "   input size  |                                pattern size                                   вууууууууу"
        println(globalDelimiter)
        println(globalFormatter("Results of original program"))
        println(globalDelimiter)
        println(globalFormatter(superheader))
        ...
        println()
        println("The time measured in seconds.")
        println("There are $groupDatasetSize measures averaged in one cell of the table!")
        println()
    }
